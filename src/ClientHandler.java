...
public class ClientHandler implements Runnable{
    ...
    public static void authenticateClient(String username, String password) throws AuthenticationFailedException{
        ...
        try {
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/Hyper", "root", "eswari12");

            Statement st = con.createStatement();

            ResultSet rs = st.executeQuery("select password from users where name like \"" + username + "\"");
